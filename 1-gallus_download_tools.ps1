...
# Download ADK
Invoke-WebRequest -Verbose -Uri https://go.microsoft.com/fwlink/?linkid=2196127 -OutFile $PWD\toolsdl\adk.exe
# Download ADK PE
Invoke-WebRequest -Verbose -Uri https://go.microsoft.com/fwlink/?linkid=2196224 -OutFile $PWD\toolsdl\adkpe.exe
# Download MDT
