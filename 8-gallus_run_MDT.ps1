...
Rename-Item "DS001:\Operating Systems\win11\Windows 11 Enterprise N in Win11x64_EntN_en-US_22H2 install.wim" "DS001:\Operating Systems\Win11\Win11x64_EntN_en-US_22H2 install.wim"
# 4
