...
"5-gallus_download_HardeningKitty.ps1",
"6-gallus_cleanup_MDT.ps1",
"7-gallus_run_MDT.ps1",
"8-gallus_build_USB_media.ps1",
"README.md"
)
...
# 5
$PWD\5-gallus_download_HardeningKitty.ps1
# 6
$PWD\6-gallus_cleanup_MDT.ps1
# 7
$PWD\7-gallus_run_MDT.ps1
# 8
$cleUSB = Read-Host -Prompt 'Veuillez saisir le périphérique USB où déployer l''installateur (ex: "F:")'
$PWD\8-gallus_build_USB_media.ps1 $cleUSB
