...
Copy-Item -Verbose -Recurse -Path $PWD\windl\tmp\* -Destination $PWD\Windows11x64_Pro_en-US_22H2
...
DISM /Export-Image /SourceImageFile:$PWD\windl\win.esd /SourceIndex:2 /DestinationImageFile:$PWD\Windows11x64_Pro_en-US_22H2\sources\boot.wim /Compress:max /CheckIntegrity
# Extract WinPE with Windows Setup to boot.wim index 2
DISM /Export-Image /SourceImageFile:$PWD\windl\win.esd /SourceIndex:3 /DestinationImageFile:$PWD\Windows11x64_Pro_en-US_22H2\sources\boot.wim /Compress:max /CheckIntegrity
# Extract Windows 11 Enterprise N WIM
DISM /Export-Image /SourceImageFile:$PWD\windl\win.esd /SourceIndex:7 /DestinationImageFile:$PWD\Windows11x64_Pro_en-US_22H2\sources\install.wim /Compress:max /CheckIntegrity
