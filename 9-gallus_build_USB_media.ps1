...
Write-Host -ForegroundColor Green "Formattage du média amovible"
Format-Volume -Verbose -DriveLetter $DestDrive[0] -FileSystem FAT32
Write-Host -ForegroundColor Green "Génération du média amovible d'installation"
