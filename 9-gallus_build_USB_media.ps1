...
DISM /Split-Image /ImageFile:"GMedia\Content\Deploy\Operating Systems\Win11x64_Ent_en-US_22H2\sources\install.wim" /SWMFile:"$DestDrive\Deploy\Operating Systems\Win11x64_Ent_en-US_22H2\sources\install.swm" /FileSize:3800
