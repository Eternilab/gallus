...
$ReportHeader = Generate-Header -Title "Gallus Audit Report" -Subtitle "Generated by <strong>Hardening Kitty</strong> on $(Get-Date)"
...
$GhiHeader = Generate-Header -Title "Gallus GHI" -Subtitle "à date du $(Get-Date)"
